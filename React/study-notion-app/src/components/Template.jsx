        ...
        <div className='text-white w-11/12 sm:max-w-[1160px] flex flex-wrap-reverse sm:flex-nowrap justify-center sm:justify-between py-12 mx-auto gap-10 sm:gap-x-12 overflow-x-hidden'>
            ...
            <div className='w-11/12 max-w-[450px]'>
                ...
                <p className='text-[1.125rem] leading[1.625rem] mt-4'>
                    <span className='text-custom-text'>{desc1}</span><br />
                ...
                <div>
                    {formtype === "signup" ? ( <button className='w-full flex justify-center items-center 
                    rounded-[8px] font-medium text-custom-text border border-richblack-700 px-[12px] py-[8px]
                    gap-x-2 mt-6'>
                        <FcGoogle />
                        sign up with google
                    </button> ) : ( <button className='w-full flex justify-center items-center 
                    rounded-[8px] font-medium text-custom-text border border-richblack-700 px-[12px] py-[8px]
                    gap-x-2 mt-6'>
                        <FcGoogle />
                        sign in with google
