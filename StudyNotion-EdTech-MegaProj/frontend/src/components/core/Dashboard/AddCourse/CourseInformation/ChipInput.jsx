    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className="flex w-full flex-wrap gap-y-2">
        ...
        {chips.map((chip, index) => (
          <div
            key={index}
            className="m-1 flex items-center rounded-full bg-richblack-700 px-3 py-1 text-sm text-richblack-25 border border-richblack-600"
          >
            ...
            <button
              type="button"
              className="ml-2 focus:outline-none text-richblack-300 hover:text-pink-200"
